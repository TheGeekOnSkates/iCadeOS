...
var sound = {
	...
	WhiteNoise: function() {
		var bufferSize = 2 * sound.audio.sampleRate,
			noiseBuffer = sound.audio.createBuffer(1, bufferSize, sound.audio.sampleRate),
			output = noiseBuffer.getChannelData(0);
		for (var i = 0; i < bufferSize; i++) {
			output[i] = Math.random() * 2 - 1;
		}
		var whiteNoise = sound.audio.createBufferSource();
	...
	PinkNoise: function() {
		...
		return (function() {
			...
			var node = sound.audio.createScriptProcessor(bufferSize, 1, 1);
